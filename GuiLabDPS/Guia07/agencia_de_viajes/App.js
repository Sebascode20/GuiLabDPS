...
const App = () => {
  ...
  const [modalVisiblePupusa, setModalVisiblePupusa] = React.useState(false);
  const [modalVisibleVolcanes, setModalVisibleVolcanes] = React.useState(false);
  return (
    <>
      <ScrollView>
        <Modal
        ...
        >
          <View style={styles.vistaModal}>
            <View style={styles.modal}>
              ...
              <Text>
                Las pupusas es el platillo típico más famoso de El Salvador.
              </Text>
              <Button
                title="Cerrar"
                onPress={() => {
                  setModalVisiblePupusa(!modalVisiblePupusa);
                }}
              ></Button>
            </View>
          </View>
        ...
        >
          <View style={styles.vistaModal}>
            <View style={styles.modal}>
              <Text style={styles.subtitulo}>Volcanes</Text>
              <Text>
                Los volcanes son unos de los atractivos turisticos que tiene El
                Salvador, en el país hay un total de 242 volcanes.
              </Text>
              <Button
                title="Cerrar"
                onPress={() => {
                  setModalVisibleVolcanes(!modalVisibleVolcanes);
                }}
              ></Button>
            </View>
          </View>
